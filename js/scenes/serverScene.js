...
export default class serverScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.serverButton01 = this.add.image(100, 225, "server01", 0).setInteractive()
        this.serverButton02 = this.add.image(300, 225, "server02", 0).setInteractive()
        this.serverButton03 = this.add.image(500, 225, "server03", 0).setInteractive()
        this.serverButton04 = this.add.image(700, 225, "server04", 0).setInteractive()
